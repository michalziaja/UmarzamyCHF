...
def send_email(sender, recipient, subject, message):
    ...
    smtp_port = 587
    smtp_username = 'username' # Gmail username
    smtp_password = 'xxxxxxxxxxxxxxxxxxxx' # Gmail app password
...
def lambda_handler(event, context):
    ...
    sender = 'email' # Sender email adress
    recipient = email
    ...
    try:
        ...
        recipient_admin = 'email' # Administrator email adress  
